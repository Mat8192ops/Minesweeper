...
INSTANTIATE_TEST_CASE_P(MineCountTestSuite, MineCountTestSuite, ::testing::Values(MineCountParams{10, 10, GameMode::EASY, 10}, MineCountParams{10, 10, GameMode::NORMAL, 20}, MineCountParams{10, 10, GameMode::HARD, 30}, MineCountParams{1, 1, GameMode::EASY, 0}, MineCountParams{2, 15, GameMode::EASY, 3}, MineCountParams{1, 15, GameMode::EASY, 1}));
